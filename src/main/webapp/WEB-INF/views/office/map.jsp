			...
			.load(
					function() {
						...
						for (i = 0; i < x.length; i++) {
							...
							var contentString = [ '<a href="#imgarea'+atcname[i]+'"><div id="map'+atcname[i]+'" style="border : width:150px;text-align:center;padding:10px;">'
						...
						for (i = 0; i < marker_array.length; i++) {
							...
							naver.maps.Event.addListener(marker_, "mouseover",
									function(e) {
						...
						naver.maps.Event.addListener(map,
								'streetLayer_changed', function(streetLayer) {
									if (streetLayer) {
