    ...
    <c:forEach var="dto" items="${list}">
        <div class="media g-mb-30 media-comment">
            ...
            <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
              <div class="g-mb-15">
              	<h8 style="color:#5BA6A6"> <b> # ${dto.category} </b></h8>   
                <ul class="list-inline d-sm-flex my-0">
                <h5 class="h5 g-color-gray-dark-v1 mb-0">${dto.title}</h5>
                <div class="mb-3" hidden>
                <input type="hidden" name="regionID" id="regionID" value="${dto.regionID}">
                </div>
              ...
              <ul class="list-inline d-sm-flex my-0">
                ...
                <button type="button" class="btn btn-color2" onclick="updateM('${dto.fbID}')">신청마감</button>
