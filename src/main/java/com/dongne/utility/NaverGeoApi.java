	...
	public static String getlocation(double latitude, double longitude) {
		...
		try {
			...
			String apiURL = "https://naveropenapi.apigw.ntruss.com/map-reversegeocode/v2/gc?coords="
					+ longitude + "," +latitude
					+ "&orders=addr,admcode&output=json";
			// json
...
//		JSONObject jObj3 = (JSONObject) jObj2.get("region");
//		System.out.print("jobj2 : " + jObj2);
//		System.out.print("jobj3 : " + jObj3);
...
//		jObjRegion = (JSONObject) jObjRegion.get("name");
